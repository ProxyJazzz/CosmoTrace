...
const ModelLoader = ({ onClick }: { onClick?: (e: any) => void }) => {
  const { scene } = useGLTF('/models/spacesuit.glb');
      ...
      return (
        <Html center>
          <div style={{
            ...
            <h3 style={{ color: '#ffaa00', margin: '0 0 8px 0' }}>Spacesuit model not found</h3>
            <p style={{ margin: 0, color: 'var(--text-muted)' }}>
              Export your Blender model as spacesuit.glb and place it in public/models/
            </p>
          </div>
        </Html>
      );
...
export const SpacesuitModel: React.FC<{ onClick?: (e: any) => void }> = ({ onClick }) => {
  return (
    <ErrorBoundary>
